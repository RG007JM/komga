...
## 253. not logged `/v1/products/books/series/{uuid}` — Komga upstream raw proxy log response

Source: `server:L1314`. HTTP: `200`. Captured type: `object (8 top-level keys)`. Fixture: `upstream/unknown_v1_products_books_series_uuid/response_L1314.json`.
...
## 254. not logged `/v1/user/recommendations` — Komga upstream standard proxy log response

Source: `server:L1318`. HTTP: `200`. Captured type: `object (8 top-level keys)`. Fixture: `upstream/unknown_v1_user_recommendations/response_L1318.json`.
...
## 255. not logged `/v1/products/{uuid}/nextread` — Komga upstream standard proxy log response

Source: `server:L1321`. HTTP: `200`. Captured type: `object (1 top-level keys)`. Fixture: `upstream/unknown_v1_products_uuid_nextread/response_L1321.json`.
...
## 256. not logged `/v1/initialization` — Komga upstream standard proxy log response

Source: `server:L1324`. HTTP: `200`. Captured type: `object (1 top-level keys)`. Fixture: `upstream/unknown_v1_initialization/response_L1324.json`.
...
## 257. not logged `/v1/user/profile` — Komga upstream standard proxy log response

Source: `server:L1327`. HTTP: `200`. Captured type: `object (25 top-level keys)`. Fixture: `upstream/unknown_v1_user_profile/response_L1327.json`.
...
## 258. not logged `/v1/user/loyalty/benefits` — Komga upstream standard proxy log response

Source: `server:L1330`. HTTP: `200`. Captured type: `object (1 top-level keys)`. Fixture: `upstream/unknown_v1_user_loyalty_benefits/response_L1330.json`.
...
## 259. not logged `/v1/products/books/subscriptions` — Komga upstream raw proxy log response

Source: `server:L1332`. HTTP: `200`. Captured type: `array (3 entries)`. Fixture: `upstream/unknown_v1_products_books_subscriptions/response_L1332.json`.
...
## 260. not logged `/v1/deals` — Komga upstream standard proxy log response

Source: `server:L1335`. HTTP: `200`. Captured type: `object (1 top-level keys)`. Fixture: `upstream/unknown_v1_deals/response_L1335.json`.
...
## 261. not logged `/v1/assets` — Komga upstream standard proxy log response

Source: `server:L1338`. HTTP: `200`. Captured type: `object (2 top-level keys)`. Fixture: `upstream/unknown_v1_assets/response_L1338.json`.
...
## 262. not logged `/v1/analytics/gettests` — Komga upstream standard proxy log response

Source: `server:L1341`. HTTP: `200`. Captured type: `object (3 top-level keys)`. Fixture: `upstream/unknown_v1_analytics_gettests/response_L1341.json`.
...
## 263. not logged `/v1/library/sync` — Komga upstream standard proxy log response

Source: `server:L1347`. HTTP: `200`. Captured type: `array (0 entries)`. Fixture: `upstream/unknown_v1_library_sync/response_L1347.json`.
...
## 264. not logged `/v1/user/wishlist` — Komga upstream standard proxy log response

Source: `server:L1350`. HTTP: `200`. Captured type: `object (8 top-level keys)`. Fixture: `upstream/unknown_v1_user_wishlist/response_L1350.json`.
...
## 265. not logged `/v1/products/books/series/{uuid}` — Komga upstream raw proxy log response

Source: `server:L1352`. HTTP: `200`. Captured type: `object (8 top-level keys)`. Fixture: `upstream/unknown_v1_products_books_series_uuid/response_L1352.json`.
...
## 266. not logged `/v1/products/books/series/{uuid}` — Komga upstream raw proxy log response

Source: `server:L1355`. HTTP: `200`. Captured type: `object (8 top-level keys)`. Fixture: `upstream/unknown_v1_products_books_series_uuid/response_L1355.json`.
...
## 267. not logged `/v1/user/recommendations` — Komga upstream standard proxy log response

Source: `server:L1359`. HTTP: `200`. Captured type: `object (8 top-level keys)`. Fixture: `upstream/unknown_v1_user_recommendations/response_L1359.json`.
...
## 268. not logged `/v1/products/{uuid}/nextread` — Komga upstream standard proxy log response

Source: `server:L1362`. HTTP: `200`. Captured type: `object (1 top-level keys)`. Fixture: `upstream/unknown_v1_products_uuid_nextread/response_L1362.json`.
...
## 269. not logged `/v1/initialization` — Komga upstream standard proxy log response

Source: `server:L1365`. HTTP: `200`. Captured type: `object (1 top-level keys)`. Fixture: `upstream/unknown_v1_initialization/response_L1365.json`.
...
## 270. not logged `/v1/user/profile` — Komga upstream standard proxy log response

Source: `server:L1368`. HTTP: `200`. Captured type: `object (25 top-level keys)`. Fixture: `upstream/unknown_v1_user_profile/response_L1368.json`.
...
## 271. not logged `/v1/user/loyalty/benefits` — Komga upstream standard proxy log response

Source: `server:L1371`. HTTP: `200`. Captured type: `object (1 top-level keys)`. Fixture: `upstream/unknown_v1_user_loyalty_benefits/response_L1371.json`.
